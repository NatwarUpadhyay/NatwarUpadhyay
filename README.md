...
- MCP security and trust evaluation, agent memory and context management, schema-first outputs using Pydantic, and making agentic systems more deterministic, legible, and safe

**🌱 I’m currently learning:**
- Advanced MCP transport layers, AI safety and governance frameworks, and how to bridge enterprise delivery principles with production agentic systems

**💬 Ask me about:**
- Systems thinking from a Merchant Navy Electro-Technical Officer career across 22 countries
- PMP-certified delivery practices and AI program governance
- PGDM in Big Data Analytics and AI/ML from Goa Institute of Management (2025)

PMP. CSM. LSSBB. Azure AI Engineer. NVIDIA Agentic AI Professional. Anthropic MCP Advanced Topics. INSEAD Generative AI and Blockchain. NISM.
